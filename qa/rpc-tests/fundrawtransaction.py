...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid zcoindark address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid zcoindark address" in e.error['message'])

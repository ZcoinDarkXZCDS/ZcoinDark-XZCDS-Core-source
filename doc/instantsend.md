...
This mechanism has been integrated into Bitcore-Node-ZcoinDark which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/zcoindarkpay/insight-api-zcoindark#web-socket-api](https://github.com/zcoindarkpay/insight-api-zcoindark#web-socket-api)
* API: [https://github.com/zcoindarkpay/insight-api-zcoindark#instantsend-transactions](https://github.com/zcoindarkpay/insight-api-zcoindark#instantsend-transactions)
...
By default, the ZcoinDark Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the ZcoinDark Core daemon:

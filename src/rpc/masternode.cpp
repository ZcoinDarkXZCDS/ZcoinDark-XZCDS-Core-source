...
UniValue masternode(const JSONRPCRequest& request)
{
    ...
    if (strCommand == "outputs") {
        ...
        pwalletMain->AvailableCoins(vPossibleCoins, true, NULL, false, ONLY_100000);
...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print ZcoinDark address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "zcoindark",               "masternode",             &masternode,             true,  {} },
    { "zcoindark",               "masternodelist",         &masternodelist,         true,  {} },
    { "zcoindark",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "zcoindark",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "zcoindark",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "zcoindark",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};

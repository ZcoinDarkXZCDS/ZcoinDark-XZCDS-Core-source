/* src/config/zcoindark-config.h.  Generated from zcoindark-config.h.in by configure.  */
/* src/config/zcoindark-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef XZCDS_CONFIG_H

#define XZCDS_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The ZcoinDark Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "ZcoinDark Core"
...
#define PACKAGE_BUGREPORT "https://github.com/zcoindarkpay/zcoindark/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "ZcoinDark Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ZcoinDark Core 0.12.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "zcoindarkcore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://zcoindark.org/"

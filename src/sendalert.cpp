...
2. run zcoindarkd with -printalert or -sendalert like this:
   /path/to/zcoindarkd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.zcoindark.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/ZcoinDark Core:0.12.0.58/"));

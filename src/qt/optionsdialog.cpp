    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("XZCDS-light"), QVariant("light"));
    ui->theme->addItem(QString("XZCDS-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("XZCDS-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("XZCDS-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("XZCDS-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("XZCDS-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("XZCDS-traditional"), QVariant("trad"));

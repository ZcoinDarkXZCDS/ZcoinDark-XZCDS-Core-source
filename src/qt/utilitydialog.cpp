    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  zcoindark-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the ZcoinDark in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 XZCDS, 0.1 XZCDS, 1 XZCDS and 10 XZCDS -- sort of like the paper money you use every day.</li> \
